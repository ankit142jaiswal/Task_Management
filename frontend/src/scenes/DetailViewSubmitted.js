...
function DetailViewSubmitted() {
    const location = useLocation();

    // const accepttask = () => {
    //     if (window.submittedList.push(window.pendingList[location.state.index])) {
    ...
    return (
        ...
        <div className='container mt-5'>
            ...
            <div className='mb-3 row p-3 ' style={{ fontSize: "larger", backgroundColor: "white", fontWeight: "bolder", boxShadow: "0 0 10px 1px rgba(0, 0, 0, 0.2)", borderRadius: "5px" }}>
                <h1 style={{ textAlign: "center" }}>Detail Task View Submitted</h1>
            ...
            <div className='mb-3'>
                {
                    window.submittedList[location.state.index] != [] ?
                                                ...
                                                <div className='col-11'>
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-auto'>
                                                            {window.submittedList[location.state.index].title}<br />
                                                        </div>
                                                    </div>
                                                        <hr />
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-auto'>:</div>
                                                        <div className='col-auto'>
                                                            {window.submittedList[location.state.index].description} <br />
                                                        </div>
                                                    </div>
                                                        <hr />
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-auto'>:</div>
                                                        <div className='col-auto'>
                                                            {window.submittedList[location.state.index].startdate} <br />
                                                        </div>
                                                    </div>
                                                        <hr />
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-auto'>:</div>
                                                        <div className='col-auto'>
                                                            {window.submittedList[location.state.index].enddate} <br />
                                                        </div>
                                                    </div>
                                                    <hr />
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-auto'>:</div>
                                                        <div className='col-auto'>
                                                            {window.submittedList[location.state.index].department}  <br />
                                                        </div>
                                                    </div>
                                                    <hr />
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-auto'>:</div>
                                                        <div className='col-auto'>
                                                            {window.submittedList[location.state.index].employee}  <br />
                                                        </div>
                                                    </div>
                                                    <hr />
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-auto'>:</div>
                                                        <div className='col-auto'>
                                                            {window.submittedList[location.state.index].email}  <br />
                                                        </div>
                                                    </div>
                                                    <hr />
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-auto'>:</div>
                                                        <div className='col-auto'>
                                                            {window.submittedList[location.state.index].uploadfile} <br />
                                                        </div>
                                                    </div>
                                                    <hr />
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-auto'>:</div>
                                                        <div className='col-auto'>
                                                            {window.submittedList[location.state.index].priority} <br />
                                                        </div>
...
export default DetailViewSubmitted