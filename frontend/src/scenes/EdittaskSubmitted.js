...
function EdittaskSubmitted() {
    ...
    const showdata = () => {
        ...
        if (window.submittedList[location.state.index] != []) {
            setTitle(window.submittedList[location.state.index].title);
            setDescription(window.submittedList[location.state.index].description);
            setStartDate(window.submittedList[location.state.index].startdate);
            setEndDate(window.submittedList[location.state.index].enddate);
            setPriority(window.submittedList[location.state.index].priority);
            setUploadfile(window.submittedList[location.state.index].uploadfile);
            setDepartment(window.submittedList[location.state.index].department);
            setEmployee(window.submittedList[location.state.index].employee);
    ...
    const collectData = (e) => {
        ...
        if (location.state.index > -1 && location.state.index < window.submittedList.length) {
            window.submittedList.splice(location.state.index, 1, data);
            window.alert("Task has Updated Successfully !!")
            console.log(window.submittedList);
            ...
            <div className='row'>
                ...
                <div className='col-11'>
                    <div className='mb-3 row p-3 ' style={{ fontSize: "larger", backgroundColor: "white", fontWeight: "bolder", boxShadow: "0 0 10px 1px rgba(0, 0, 0, 0.2)", borderRadius: "5px" }}>
                        <h1 style={{ textAlign: "center" }}>Edit Submitted Task </h1>
                    </div>
                    <form>
...
export default EdittaskSubmitted