...
function EdittaskPending() {
    ...
    const showdata = () => {
        ...
        if (window.pendingList[location.state.index] != []) {
            setTitle(window.pendingList[location.state.index].title);
            setDescription(window.pendingList[location.state.index].description);
            setStartDate(window.pendingList[location.state.index].startdate);
            setEndDate(window.pendingList[location.state.index].enddate);
            setPriority(window.pendingList[location.state.index].priority);
            setUploadfile(window.pendingList[location.state.index].uploadfile);
            setDepartment(window.pendingList[location.state.index].department);
            setEmployee(window.pendingList[location.state.index].employee);
    ...
    const collectData = (e) => {
        ...
        if (location.state.index > -1 && location.state.index < window.pendingList.length) {
            window.pendingList.splice(location.state.index, 1, data);
...
export default EdittaskPending;