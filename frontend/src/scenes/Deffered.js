...
function Deffered() {
    ...
    const deletetask = (index) => {
        ...
        if (window.defferedList.splice(index, 1)) {
    ...
    const edittask = (index) => {
        navigate('/edittaskdeffered', { state: { index: index } });
            ...
            <div className='row'>
                ...
                <div className='col-11'>
                    <div className='mb-3 row p-3 ' style={{ fontSize: "larger", backgroundColor: "white", fontWeight: "bolder", boxShadow: "0 0 10px 1px rgba(0, 0, 0, 0.2)", borderRadius: "5px" }}>
                        <h1 style={{ textAlign: "center" }}>Deffered Task <hr /></h1>
                    ...
                    <div className='mb-3'>
                        {
                            ...
                            window.defferedList.filter((item) => ((item.title.toLowerCase().includes(search.toLowerCase())) || (item.description.toLowerCase().includes(search.toLowerCase()))
