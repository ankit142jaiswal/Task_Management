...
function EditEmployee() {
    ...
    const showdata = () => {
        ...
        if (window.employeeList[location.state.index].length != 0) {
            setName(window.employeeList[location.state.index].name);
            setEmail(window.employeeList[location.state.index].email);
            setContact(window.employeeList[location.state.index].contact);
            setBio(window.employeeList[location.state.index].bio);
            setJoiningDate(window.employeeList[location.state.index].joiningdate);
            setPicture(window.employeeList[location.state.index].picture);
            setDepartment(window.employeeList[location.state.index].department);
    ...
    const collectData = (e) => {
        ...
        if (location.state.index > -1 && location.state.index < window.employeeList.length) {
            window.employeeList.splice(location.state.index, 1, data);
            window.alert("Employee Detail has been Updated Successfully !!")
    ...
    <div className='row'>
        ...
        <div className='col-11'>
            <div className='mb-3 row p-3 ' style={{ fontSize: "larger", backgroundColor: "white", fontWeight: "bolder", boxShadow: "0 0 10px 1px rgba(0, 0, 0, 0.2)", borderRadius: "5px" }}>
                <h1 style={{ textAlign: "center" }}>Edit Employee Detail </h1>
            </div>
            <hr />
            <form>
                   ...
                   <div className="mb-3 row">
                    ...
                    <div className='mb-3 row'>
                        ...
                        <div className='col-auto'>
                            ...
                            <Link to='/teammember' className="btn btn-info">Cancel</Link>
                        </div>
                        <div className='col-auto'>
